...
Kirigami.ScrollablePage {
    ...
    Component.onCompleted: PackageManager.refresh()
    ...
    ColumnLayout {
        ...
        Kirigami.Icon {
            source: UIIcons.icons.package_manager || ""
            ...
            isMask: UIIcons.shouldColorize("package_manager")
            color: UIIcons.iconColor("package_manager")
        }
        ...
        Rectangle {
            ...
            Label {
                ...
                text: "Browse and manage installed pacman packages. Use the panel to filter, check for updates, upgrade the system, or remove individual packages."
